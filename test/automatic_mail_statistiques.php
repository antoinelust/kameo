                    ...
                    <div class="col-md-12">
                        ...
                        <div class="m-t-30">
                            ...
                            while($row = mysqli_fetch_array($result))
                            {
                                ...
                                include 'include/connexion.php';
                                $sql2= "SELECT aa.NOM, aa.PRENOM, aa.EMAIL, COUNT(1) AS COUNT, SUM(DATE_END-DATE_START) AS LENGTH FROM customer_referential aa, reservations bb WHERE aa.COMPANY='$company' and aa.EMAIL = bb.EMAIL and aa.STAANN !='D' and bb.STAANN != 'D' and DATE_START>'$timestampStart' and DATE_END<'$timestampEnd' GROUP BY aa.EMAIL ORDER BY COUNT DESC";
                                ...
                                if($result2->num_rows > 0){
                                    ...
                                    $part2=$part2."<table style=\"width:100%\" class=\"tableResume\"><tr><th class=\"tableResume\">Nom</th><th class=\"tableResume\">EMAIL</th><th class=\"tableResume\">COMPANY</th><th class=\"tableResume\">Nombre de réservations</th><th class=\"tableResume\">Heures de réservation</th></tr>";
                                    ...
                                    while($row2 = mysqli_fetch_array($result2))
                                    {
                                        ...
                                        $part2=$part2."<tr class=\"tableResume\"><td class=\"tableResume\">".$firstName." ".$name."</td><td class=\"tableResume\">".$email."</td><td class=\"tableResume\">".$company."</td> <td class=\"tableResume\">".$somme."</td><td class=\"tableResume\">".$numberOfHours."</td></tr>";
                                ...
                                $sql3="select aa.FRAME_NUMBER, aa.MODEL, count(*) AS COUNT, SUM(DATE_END-DATE_START) AS LENGTH from customer_bikes aa, reservations bb where aa.company = '$company' and aa.FRAME_NUMBER=bb.FRAME_NUMBER and DATE_START>'$timestampStart' and DATE_END<'$timestampEnd'group by aa.FRAME_NUMBER";
                                if ($conn->query($sql2) === FALSE) {
                                    $response = array ('response'=>'error', 'message'=> $conn->error);
                                    echo json_encode($response);
                                    die;
                                ...
                                if($result3->num_rows > 0){
                                    ...
                                    while($row3 = mysqli_fetch_array($result3))
                                    {
                                        ...
                                        $part2=$part2."<tr class=\"tableResume\"><td class=\"tableResume\">".$frameNumber."</td><td class=\"tableResume\">".$modele."</td><td class=\"tableResume\">".$somme."</td> <td class=\"tableResume\">".$length."</td></tr>";
                                ...
                                $sql3="select aa.FRAME_NUMBER, aa.MODEL, count(*) AS COUNT, SUM(DATE_END-DATE_START) AS LENGTH from customer_bikes aa, reservations bb where aa.company = 'KAMEO' and aa.FRAME_NUMBER=bb.FRAME_NUMBER and DATE_START>'$timestampStart' and DATE_END<'$timestampEnd'group by aa.FRAME_NUMBER";
                                if ($conn->query($sql2) === FALSE) {
                                    $response = array ('response'=>'error', 'message'=> $conn->error);
                                    echo json_encode($response);
                                    die;

				...
				<div class="col-md-5">
					<div class="product-image">
						<div class="carousel" data-carousel-col="1" data-lightbox-type="gallery">
							<img alt="Shop product image!" src="images_bikes/bonsplans/orbea_gain_h1.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/orbea_gain_h2.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/orbea_gain_h3.jpg">
				...
				<div class="col-md-7">
					<div class="product-description">
						...
						<div class="product-title">
							<h3><a href="#">Orbea</a></h3>
							<p>Gain</p>
							<p><strong>Cadre Homme - Taille L</strong></p>
							<p><strong>Kilomètres parcourus : - 200 km</strong></p>
						</div>
						<div class="product-price"><ins class="text-green">2000€</ins>
						</div>
						

						<div class="seperator m-b-10"></div>
						<h4>Caractéristiques techniques</H4>
						<p>Voir le <a href="https://www.orbea.com/be-fr/" target="_blank">site de la marque</a>.</p>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
						...
						<p>Envoyez nous un mail à l'adresse suivante <a href="mailto:info@kameobikes.com?subject=Achat OB-F10 homme&body=Merci de renseigner vos coordonnées: Nom, Prénom, mail, téléphone. Nous vous contacterons dès que possible.">info@kameobikes.com</a> en nous communiquant vos coordonnées complètes.</p>

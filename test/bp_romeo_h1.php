				...
				<div class="col-md-5">
					<div class="product-image">
						<div class="carousel" data-carousel-col="1" data-lightbox-type="gallery">
							<img alt="Shop product image!" src="images_bikes/bonsplans/romeo_h1_1.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/romeo_h1_2.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/romeo_h1_3.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/romeo_h1_4.jpg">
				...
				<div class="col-md-7">
					<div class="product-description">
						...
						<div class="product-title">
							<h3><a href="#">Derry</a></h3>
							<p>Romeo</p>
							<p><strong>Cadre Homme - Taille M</strong></p>
							<p><strong>Kilomètres parcourus : 1048 km</strong></p>
						</div>
						<div class="product-price"><ins class="text-green">1000€</ins>
						</div>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
						...
						<p>Envoyez nous un mail à l'adresse suivante <a href="mailto:info@kameobikes.com?subject=Achat RM-651 homme&body=Merci de renseigner vos coordonnées: Nom, Prénom, mail, téléphone. Nous vous contacterons dès que possible.">info@kameobikes.com</a> en nous communiquant vos coordonnées complètes.</p>

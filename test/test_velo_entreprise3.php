...
<div class="col-md-12">
	...
	<h1>Vos employés sont précieux, <bold class="text-green">prenez en soin.</bold></h1>
    </div>
</div>

                        
                        <!-- INSPIRO SLIDER -->
				        <div id="slider" class="inspiro-slider" data-height-md="160">
				            <!-- Slide 1 -->
				            <div class="slide" style="background-image:url('images/cycliste_travail3.jpg');">
				                <div class="container">
				                    <div class="slide-captions">
				                        <!-- Captions -->
				                        <h1 class="fr">Et si tous vos employés étaient</h1>
				                        <h2 data-caption-animation="rotateInUpLeft" class="text-light">Toujours
				                        <bold data-caption-animation="rotateInUpLeft" data-caption-delay="300" class="text-green">à l'heure</bold></h2>
				                        <!-- End: Captions -->
				                    </div>
				                </div>
				            </div>
				            <!-- END: Slide 1 -->
				            <!-- Slide 2 -->
				            <div class="slide" style="background-image:url('images/cycliste_travail4.jpg');">
				                <div class="container">
				                    <div class="slide-captions text-right">
				                        <!-- Captions -->
				                        <h1 class="fr text-green">Et si tous vos employés arrivaient</h1>
				                        <h2 data-caption-animation="rotateInUpRight" class="text-light">Avec le
				                        <bold data-caption-animation="rotateInUpRight" class="text-green">sourire</bold></h2>
				                        <!-- End: Captions -->
				                    </div>
				                </div>
				            </div>
				            <!-- END: Slide 2 -->
				            <!-- Slide 1 -->
				            <div class="slide" style="background-image:url('images/cycliste_travail2.jpg');">
				                <div class="container">
				                    <div class="slide-captions">
				                        <!-- Captions -->
				                        <h1 class="fr text-light">Et si tous vos employés étaient</h1>
				                        <h2 data-caption-animation="rotateInUpLeft" class="text-light">Toujours
				                        <bold data-caption-animation="rotateInUpLeft" data-caption-delay="300" class="text-green">en forme</bold></h3>
				                        <!-- End: Captions -->
				                    </div>
				                </div>
				            </div>
...
<!-- SECTION  -->
<section class="background-colored p-b-0">
	<div class="container">
		<div class="row">
			
			<div class="col-md-12 text-center">
				<p class="lead text-light">Augmentez le pouvoir d'achat de vos employés à coût équivalent pour votre entreprise en leur apportant une <bold class="text-dark">solution de mobilité respectueuse de l'environnement</bold>.</p>
				<a href="#proposition" class="scroll-to button red button-3d icon-right full-rounded"></i>Découvrez notre offre test</a>
			</div>	 		
...
<section class="">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12 text-center">
				<h3>KAMEO Bikes vous propose le leasing de vélos</h3>
				<p class="lead text-light">Il peut être financé par l'entreprise ou le travailleur via son salaire brut.<br>
				 Ce système est avantageux pour le travailleur qui voit son pouvoir d'achat augmenter et pour vous.<br>
				 Car en venant en vélos vos employés sont <bold class="text-green">en forme, à l'heure et ont le sourire</bold> !</p>
			</div>	 			
			<hr class="space">
		</div>
	</div>
...
<section class="background p-b-0" id="proposition">
	<div class="container">
		<div class="row">
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <form id="widget-contact-form" action="include/contact-form.php" role="form" method="post">
                        ...
                        <input type="text" class="hidden" id="widget-contact-form-subject" name="widget-contact-form-subject" value="Nouveau mail depuis test_velo_entreprise3.php" />                    
                                ...
                                jQuery(form).ajaxSubmit({
                                    success: function(text) {
                                        if (text.response == 'success') {
                                            ...
                                            gtag('event', 'send', {
                                              'event_category': 'mail',
                                              'event_label': 'test_velo_entreprise3.php'
                                            });
		...
		<div class="row">
			...
			<div class="col-md-12 text-center">
				...
				<div class="post-video">
					<iframe src='https://www.rtc.be/playerjs/embed.php?id=1501476' width='500' height='281'></iframe>
				</div>

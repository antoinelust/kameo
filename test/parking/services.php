            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="fr">SERVICES</h2>
                        </div>
                        <p class="fr">Vous aimeriez comander un service lors de votre passage au parking vélo?
                        <br>Veuillez remplir ce formulaire</p> 
                        
                        <h4>Rappel des différents services, précision de ceux-ci et tarifs</h4>
                        ...
                        <div class="m-t-30">
                            <form id="widget-contact-form" action="include/order-form.php" role="form" method="post">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label for="phone"  id="fr">Date désirée</label>
                                        <input type="date" aria-required="true" name="widget-contact-form-date" class="form-control required date">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label for="tarif"  id="fr">Service demandé</label>
                                ...
                                <h4>Prix total: <strong class="text-pink">27€</strong></h4>

...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 if($email != '') {
     ...
     if($transport!="personnalCar" && $transport!="companyCar"){
         $transportationEssence="N/A";
     }
    ...
    $mail->Subject = "Demande de simulation pour calcul Cash4Bike pour ".$firstName." ".$name;
    ...
    <html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\">
        <head>
            ...
            <title>Kameo Bikes - Simulation Cash4Bike</title>
    ...
    <br>
    <strong>$firstName $name ($entreprise):</strong><br>
    Type: $type<br>
    Revenu : $revenu<br>
    Adresse domicile : $domicile<br>

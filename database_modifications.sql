...
CREATE TABLE `kameobiknq`.`companies_contact` ( `ID` INT(3) NOT NULL , `NOM` VARCHAR(250) NOT NULL , `PRENOM` VARCHAR(250) NOT NULL , `EMAIL` VARCHAR(250) NOT NULL , `PHONE` VARCHAR(15) NULL , `ID_COMPANY` INT NOT NULL, `BIKES_STATS` BOOLEAN NOT NULL ) ENGINE = MyISAM;

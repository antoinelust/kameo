...
CREATE TABLE `kameobiknq`.`entretiens` ( `ID` INT(10) NOT NULL , `HEU_MAJ` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , `USR_MAJ` VARCHAR(150) NOT NULL , `BIKE_ID` INT(10) NOT NULL , `DATE` TIMESTAMP NOT NULL , `STATUS` VARCHAR(100) NOT NULL , `COMMENT` TEXT NULL , PRIMARY KEY (`ID`)) ENGINE = MyISAM;

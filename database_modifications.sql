...
CREATE TABLE `kameobiknq`.`accessories_catalog` ( `ID` INT(3) NOT NULL AUTO_INCREMENT , `NAME` VARCHAR(100) NOT NULL , `BUYING_PRICE` FLOAT NOT NULL , `PRICE_HTVA` FLOAT NOT NULL , `STOCK` BOOLEAN NOT NULL , `SHOW_ACCESSORIES` BOOLEAN NOT NULL , `DESCRIPTION` TEXT NOT NULL , `ACCESSORIES_CATEGORIES` INT(3)
...
CREATE TABLE `kameobiknq`.`companies_contact` ( `ID` INT(3) NOT NULL AUTO_INCREMENT , `NOM` VARCHAR(250) NOT NULL , `PRENOM` VARCHAR(250) NOT NULL , `EMAIL` VARCHAR(250) NOT NULL , `PHONE` VARCHAR(15) NULL , `ID_COMPANY` INT NOT NULL, `BIKES_STATS` VARCHAR(1) NOT NULL, PRIMARY_KEY(`ID`) ) ENGINE = MyISAM;

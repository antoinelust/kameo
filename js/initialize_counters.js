        ...
        success: function(response){
            ...
            if(response.response == 'success'){
                ...
                if(response.company=='KAMEO'){
					...
					document.getElementById('counterChat').innerHTML = "<span data-speed=\"1\" data-refresh-interval=\"4\" data-to=\""+response.messagesNumberUnread+"\" data-from=\"0\" data-seperator=\"true\">"+response.messagesNumberUnread+"</span>"; 					

...
try{
    ...
    $email=isset($_POST['emailUser']) ? $_POST['emailUser'] : NULL;


    $start=isset($_POST['dateStart']) ? substr($_POST['dateStart'], 0, 16) : NULL;
    $end=isset($_POST['dateEnd']) ? substr($_POST['dateEnd'], 0, 16) : NULL;
    ...
    if($company=="Engie"){
        ...
        <body>
                <!--*|IF:MC_PREVIEW_TEXT|*-->
                <!--[if !gte mso 9]><!----><span class=\"mcnPreviewText\" style=\"display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;\">$frameNumber a été réservé </span><!--<![endif]-->
                <!--*|END:IF|*-->
                <center>
                        ...
                        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"max-width:100%; min-width:100%;\" width=\"100%\" class=\"mcnTextContentContainer\">
                            <tbody><tr>
                                ...
                                <br><br>
                                    ...
                                    <br>
                                    <p>L'équipe <strong>KAMEO Bikes</strong></p>
                                </td>
                            </tr>
        ...
        $mail->Subject = "Nouvelle réservation de vélo";
        ...
        $response = array ('response'=>'success', 'message'=> "no mail to sent");
        echo json_encode($response);
        die;
    }
    
}catch(EXCEPTION $e){
    $response = array ('response'=>'error', 'message'=> $e);
    echo json_encode($response);
    die;
}

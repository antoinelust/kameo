...
FROM factures WHERE BENEFICIARY_COMPANY IN ('Ange et demon (GEEBEE)', 'Velo decathlon', 'Bzen', 'Bike Avenue', 'Cycle Me', 'Hartje', 'Galerie du cycle', 'HNF Nicolai', 'Evobikes', 'Ahooga', 'Guru Sport', 'Firma', 'Douze Cycles', 'DOUZE FACTORY', 'La roue Libre') AND AMOUNT_HTVA<(-1000)

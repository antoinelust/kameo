                ...
                <table align=\"left\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"max-width:100%; min-width:100%;\" width=\"100%\" class=\"mcnTextContentContainer\">
                  <tbody><tr>
                    <td valign=\"top\" class=\"mcnTextContent\" style=\"padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;\">
                      ...
                      <h3>La borne a été refermée</h3>

                      <p>Vous recevez cet email car nous avons détecté que la porte de votre borne est maintenant refermée<br/>
                      <br>
                      <strong>Identifiant de votre borne : </strong>". $boxID." </p>
                    </td>
                    <td valign=\"top\" class=\"mcnTextContent\" style=\"padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;\">

                      <h3>De box is gesloten</h3>

                      <p>U ontvangt deze e-mail omdat we hebben gedetecteerd dat de deur van uw box nu gesloten is<br>
                      <br>
                      <strong>ID van box : </strong> ". $boxID." </p>
                    </td>
                  </tr>
                </tbody></table>
                <!--[if mso]>

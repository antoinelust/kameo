...
try{
  if(isset($_GET['action'])){
    ...
    if($action=="list"){
      ...
      from bike_catalog where bike_catalog.STAANN != 'D' AND not EXISTS (SELECT 1 from customer_bikes where COMPANY='KAMEO' AND bike_catalog.ID=customer_bikes.TYPE and customer_bikes.CONTRACT_TYPE='stock') AND EXISTS (SELECT 1 from customer_bikes where COMPANY='KAMEO' AND bike_catalog.ID=customer_bikes.TYPE and customer_bikes.CONTRACT_TYPE='order'))
      ...
      from bike_catalog where STAANN != 'D' AND not EXISTS (SELECT 1 from customer_bikes where COMPANY='KAMEO' AND bike_catalog.ID=customer_bikes.TYPE and customer_bikes.CONTRACT_TYPE='stock') AND NOT EXISTS (SELECT 1 from customer_bikes where COMPANY='KAMEO' AND bike_catalog.ID=customer_bikes.TYPE and customer_bikes.CONTRACT_TYPE='order'))

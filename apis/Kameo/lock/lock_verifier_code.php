...
if ($is_null)
{
	...
	if($reponse->fetch())
	{
		...
		execSQL("INSERT INTO reservations_details (ACTION, RESERVATION_ID, BUILDING, OUTCOME) VALUES (?, ?, ?, ?)", array('sis', 'verifier_code', '9999', $_GET['building'], '-2'), true);
...
{
	echo "-3"; 	// Mauvais code
	execSQL("INSERT INTO reservations_details (ACTION, RESERVATION_ID, BUILDING, OUTCOME) VALUES (?, ?, ?, ?)", array('sis', 'verifier_code', '9999', $_GET['building'], '-3'), true);

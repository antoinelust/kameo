...
if(isset($_POST['action']))
{
    ...
    }else if($_POST["action"]=="switch_out"){
        include 'connexion.php';
        $sql="UPDATE locking_bikes SET HEU_MAJ=CURRENT_TIMESTAMP, PLACE_IN_BUILDING='-1' WHERE BIKE_ID='$id'";
    ...
    }else if($_POST["action"]=="switch_in"){
        include 'connexion.php';
        $place = $_POST["place"];

...
if($ID==NULL){
	...
	execSQL("UPDATE notifications SET HEU_MAJ=CURRENT_TIMESTAMP, USR_MAJ='update_end_booking.php', STAAN='D' WHERE TYPE_ITEM=? AND TYPE='lateBooking'", array('i', $ID), true);

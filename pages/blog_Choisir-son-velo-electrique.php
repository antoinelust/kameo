		...
		<br>
                ...
                <div class="post-item">
                    ...
                    <div class="post-content-details col-md-8 center">
                        ...
                        <p class="text-justify text-dark">Si vous comptez utiliser votre vélo pour vos trajets domicile-travail, veillez à prendre un vélo tout équipé. L’équipement conseillé est :</p>
						<ul>
                        ...
                        <p class="text-justify text-dark">En Belgique nous avons différents types de dénivelé. Nous vous conseillons au minimum les moteurs suivants selon votre ville et pour une utilisation vélo-taff  :</p>
						<ul>

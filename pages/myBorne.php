			...
			<div class="container">
				...
				<div id="tabs-05c" class="tabs color">
					...
					<div class="tabs-content">
						...
						<p class="text-dark">Dans son objectif d’amélioration continue de la mobilité, Kameo vous présente son produit de gestion de flotte de véhicule : MyBorne.<br>

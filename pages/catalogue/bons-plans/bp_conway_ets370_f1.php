				...
				<div class="col-md-5">
					<div class="product-image">
						<div class="carousel" data-carousel-col="1" data-lightbox-type="gallery">
							<img alt="Shop product image!" src="images_bikes/bonsplans/conway_ets370_f1_1.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/conway_ets370_f1_2.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/conway_ets370_f1_3.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/conway_ets370_f1_4.jpg">
				...
				<div class="col-md-7">
					<div class="product-description">
						...
						<div class="product-title">
							...
							<p>Ets 370</p>
							<p><strong>Cadre Femme - Taille L</strong></p>
							<p><strong>Kilomètres parcourus : 1985,9 km</strong></p>
						</div>
						<div class="product-price"><ins class="text-green">1570€</ins> htva
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
						...
						<p>Envoyez nous un mail à l'adresse suivante <a href="mailto:info@kameobikes.com?subject=Achat CW-370f1 femme&body=Merci de renseigner vos coordonnées: Nom, Prénom, mail, téléphone. Nous vous contacterons dès que possible.">info@kameobikes.com</a> en nous communiquant vos coordonnées complètes.</p>

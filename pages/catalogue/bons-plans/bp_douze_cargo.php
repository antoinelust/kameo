				...
				<div class="col-md-5">
					<div class="product-image">
						<div class="carousel" data-carousel-col="1" data-lightbox-type="gallery">
							<img alt="Shop product image!" src="images_bikes/bonsplans/douze_cargo1.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/douze_cargo2.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/douze_cargo3.jpg">
				...
				<div class="col-md-7">
					<div class="product-description">
						...
						<div class="product-title">
							<h3><a href="#">Douze Cycles</a></h3>
							<p>G4 Mixte</p>
							<p><strong>Vélo Cargo - Taille unique</strong></p>
							<p><strong>Kilomètres parcourus : 120 km</strong></p>
						</div>
						<div class="product-price"><ins class="text-green">3305€</ins> htva
						...
						<p>Voir le <a href="https://www.douze-cycles.com/g4e-3/" target="_blank">site de la marque</a>.</p>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
						...
						<p>Envoyez nous un mail à l'adresse suivante <a href="mailto:info@kameobikes.com?subject=Achat DZ-12 &body=Merci de renseigner vos coordonnées: Nom, Prénom, mail, téléphone. Nous vous contacterons dès que possible.">info@kameobikes.com</a> en nous communiquant vos coordonnées complètes.</p>

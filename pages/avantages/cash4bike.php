...
<div class="modal fade" id="detail" tabindex="-1" role="modal" aria-labelledby="modal-label" aria-hidden="true" style="display: none;">
	...
	<div class="carousel" data-lightbox-type="gallery">
		...
		<div class="portfolio-item">
			<div class="portfolio-image effect">
				<img src="images_bikes/conway_cairon-t-600_h.jpg" alt="">
			</div>
			<div class="portfolio-description">
				<h4 class="title">CONWAY</h4>
				<p>Cairon T 600 Homme<br>
				Ville et chemin<br>
				<b>Achat : 3223 €</b><br>
				Coût brut : 135 €/mois<br>
				<b class="text-red">Cout réel : 15 €/mois <i class='fa fa-question-circle'></i></b></p>
			</div>
		</div>

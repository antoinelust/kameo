	...
	<div class="container">
		<div class="row">
				...
				<div class="heading heading text-left m-b-20">
					...
					<h2 class="nl">Onze accessoires</h2>
				</div>
				<br>
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<div class="modal-footer en">
								<a class="button green button-3d rounded effect icon-left" href="commander.php"><span><i class="fa fa-eye"></i>Order</span></a>
							...
							<div class="modal-footer nl">
								<a class="button green button-3d rounded effect icon-left" href="commander.php"><span><i class="fa fa-eye"></i>Bestellen</span></a>

				...
				<div class="col-md-5">
					<div class="product-image">
						<div class="carousel" data-carousel-col="1" data-lightbox-type="gallery">
							<img alt="Shop product image!" src="images_bikes/bonsplans/conway_ets370_f4_1.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/conway_ets370_f4_2.jpg">
							<img alt="Shop product image!" src="images_bikes/bonsplans/conway_ets370_f4_3.jpg">
				...
				<div class="col-md-7">
					<div class="product-description">
						...
						<div class="product-title">
							...
							<p><strong>Kilomètres parcourus : 1009,1 km</strong></p>
						</div>
						<div class="product-price"><ins class="text-green">1611€</ins> htva
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
						...
						<p>Envoyez nous un mail à l'adresse suivante <a href="mailto:info@kameobikes.com?subject=Achat CW-370f4 femme&body=Merci de renseigner vos coordonnées: Nom, Prénom, mail, téléphone. Nous vous contacterons dès que possible.">info@kameobikes.com</a> en nous communiquant vos coordonnées complètes.</p>
